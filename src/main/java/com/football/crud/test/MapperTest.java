...
//		departmentMapper.insertSelective(new Department(null, "测试部"));
		...
		//2、生成员工数据，测试员工插入
//		employeeMapper.insertSelective(new Employee(null, "Jerry", "M", "Jerry@football.com", 1));
		
		//3、批量插入多个员工；批量，使用可以执行批量操作的sqlSession
		/*
		 * for() { employeeMapper.insertSelective(new Employee(null, "Jerry", "M",
		 * "Jerry@football.com", 1)); }
		 */
		/*
		 ...
		 * 5)+i; mapper.insertSelective(new Employee(null, uid, "M",
		 * uid+"@football.com", 1)); } System.out.println("批量完成");
		 */
	}
}
