...
<body>
				...
				<div class="modal-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control" id="email_update_input" placeholder="Email@lfc.com">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">录入成员</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal">
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">邮箱</label>
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control" id="email_add_input" placeholder="Email@lfc.com">
								<span class="help-block"></span>
							</div>
						</div>
						<div class="form-group">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12" style="margin-top: 10px;">
				<span style="font-size: 23px;background: #4F94CD;" class="badge">球队成员</span>
			</div>
		</div>
		<!-- 按钮 -->
		<div class="row">
			<div class="col-md-4 col-md-offset-8">
				...
				<button class="btn btn-danger" id="emp_delete_all_btn">解雇</button>
			</div>
		</div>
		<!-- 显示表格数据 -->
		<div class="row">
	...
	<script type="text/javascript">
		...
		function build_page_nav(result){
			...
			var firstPageLi = $("<li></li>").append($("<a></a>").append("首页").css("cursor","pointer"));
			var prePageLi = $("<li></li>").append($("<a></a>").append("上页").css("cursor","pointer"));
			...
			var nextPageLi = $("<li></li>").append($("<a></a>").append("下页").css("cursor","pointer"));
			var lastPageLi = $("<li></li>").append($("<a></a>").append("末页").css("cursor","pointer"));
		...
		function validate_add_form(){
			...
			var regName = /(^[a-zA-Z0-9_-]{6,16}$)|(^[\u2E80-\u9FFF]{1,20})/;
			if(!regName.test(empName)){
				show_validate_msg("#empName_add_input","error","用户名可以是1-20位中文或者6-16位英文和数字的组合");
				//alert("用户名可以是1-20位中文或者6-16位英文和数字的组合");
				return false;
			}else {
	...
	<div style="color: rgba(0,0,0,.45);text-align: center;font-size: 14px;">Copyright © 2020 段琦</div>
